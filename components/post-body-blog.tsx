...
const PostBodyBlog = ({ content }: Props) => {
	return (
		<div className='max-w-2xl prose prose-lg mx-auto content-center text-justify items-center justify-center align-middle sm:max-w-2xl md:max-w-3xl lg:max-w-4xl xl:max-w-5xl'>
			<ReactMarkdown
