...
const Card = () => {
    const iconMap = iconLinks.map(link => (
		...
		>
			<FontAwesomeIcon icon={link.icon} className='align-middle text-center' fontSize='xl' />
		</a>
	));
	return (
        ...
        <div className="max-w-xs rounded overflow-hidden shadow-lg my-4 inline-block mx-8 justify-center">
            <img className="w-full" src="https://res.cloudinary.com/asross311/image/upload/v1596621036/ASR_Assets/windy-city-devs_xrktse.jpg" alt="next" />
			...
			<div className='flex flex-col items-center justify-center bg-white px-4 pt-4 shadow rounded-lg'>
				...
				<h6 className='mt-2 text-sm font-medium'>Modernizing Web Development</h6>
